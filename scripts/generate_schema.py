...
Output: schemas/trace-v0.1.json
"""
...
def main() -> None:
    ...
    schema["$id"] = "https://trace-protocol.org/schemas/trace-v0.1.json"
    schema["title"] = "TRACE Session Schema v0.1"
    schema["description"] = (
    ...
    out_path = SCHEMA_DIR / "trace-v0.1.json"
